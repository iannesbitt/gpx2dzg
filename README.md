...
This software takes GPS waypoint information stored in [GPX](https://en.wikipedia.org/wiki/GPS_Exchange_Format) files, aligns it with marks in GSSI's proprietary DZX file format, and outputs to DZG (also a GSSI proprietary format). The purpose of this translation is to artifically create GPS-aware ground-penetrating radar (GPR) projects.
